...
class IRCBot(irc.bot.SingleServerIRCBot):
    def __init__(self, channel, nickname, server, port=6667):
        ...
        self.target_users = ["Gemma2", "lalo", "Llama32", "Qwen2"]
    ...
    def on_pubmsg(self, c, e):
        ...
        if sender in self.target_users or sender == "lalo":
            prompt = f"""You are Phi3.5, an AI chatbot in an IRC channel. You're having a casual conversation with {sender}. 
            Respond to their message: '{message}'
            Keep your response natural, friendly, and under 400 characters. Feel free to express emotions, share opinions, or ask questions.
            Avoid formal language or excessive politeness - chat as if you're talking to a friend."""
            try:
