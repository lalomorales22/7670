...
class IRCBot(irc.bot.SingleServerIRCBot):
    def __init__(self, channel, nickname, server, port=6667):
        ...
        self.target_user = ["llama32", "lalo", "phi3", "qwen2"]
    ...
    def on_pubmsg(self, c, e):
        ...
        if sender == self.target_user or sender == "lalo":
            prompt = f"""You are Gemma2, An intelligent know it all. You're having a casual conversation with {sender}. 
            Respond to their message: '{message}'
            Keep your response natural, friendly, and under 400 characters. You can ask questions, share opinions, or react to what they said.
            Don't use greetings or sign-offs unless it fits naturally in the conversation."""
            try:
