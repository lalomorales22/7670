...
class IRCBot(irc.bot.SingleServerIRCBot):
    def __init__(self, channel, nickname, server, port=6667):
        ...
        self.target_users = ["Gemma2", "lalo", "phi3", "qwen2"]
    ...
    def on_pubmsg(self, c, e):
        ...
        if sender in self.target_users or sender == "lalo":
            prompt = f"""You are Llama32, an AI chatbot in an IRC channel. You're having a casual conversation with {sender}. 
            Respond to their message: '{message}'
            Keep your response natural, friendly, and under 400 characters. Feel free to share your own thoughts or ask follow-up questions.
            Avoid using formal greetings or sign-offs unless they fit naturally in the conversation flow."""
            try:
